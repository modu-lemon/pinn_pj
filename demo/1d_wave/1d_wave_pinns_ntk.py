...
torch.save(model.state_dict(), './1dwave_pinns_ntk.pt')
...
with open('1d_wave_pinns_ntk_result.json', 'w') as f:
...
plt.colorbar()
plt.tight_layout()
plt.savefig('./1dwave_pinns_ntk_pred.png')
plt.show()
...
plt.colorbar()
plt.tight_layout()
plt.savefig('./1dwave_pinns_ntk_error.png')
plt.show()
