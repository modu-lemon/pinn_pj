...
torch.save(model.state_dict(), './convection_pinns_diffusion.pt')
...
with open('convection_pinns_diffusion_result.json', 'w') as f:
...
plt.colorbar()
plt.tight_layout()
plt.savefig('./convection_pinns_diffusion_pred.png')
plt.show()
...
plt.colorbar()
plt.tight_layout()
plt.savefig('./convection_pinns_diffusion_exact.png')
plt.show()
...
plt.colorbar()
plt.tight_layout()
plt.savefig('./convection_pinns_diffusion_error.png')
plt.show()
...
plt.colorbar()
plt.tight_layout()
plt.savefig('./convection_pinns_diffusion_sample.png')
plt.show()